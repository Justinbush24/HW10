...
const mainHTML = require('./templates/mainHTML.html');

// Cards
const managerCard = require('./templates/managerHTML.html');
const internCard = require('./templates/internhtml.html');
const engineerCard = require('./templates/engineerhtml.html');
